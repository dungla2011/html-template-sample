	...
	<div class="page_layout clearfix">
		<div class="row page_margin_top">
			<div class="column column_2_3">
				<h4 class="box_header">Headings</h4>
				<h1 class="page_margin_top">Heading H1</h1>
				<p class="text">
					...
					Metro pulvinare est dosis cuprum elite gravida adiscipling nulla gravida est.
				</p>
				<h2 class="page_margin_top">Heading H2</h2>
				<p class="text">
					Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.
					Metro pulvinare est dosis cuprum elite gravida adiscipling nulla gravida est.
				</p>
				<h3 class="page_margin_top">Heading H3</h3>
				<p class="text">
					Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.
					Metro pulvinare est dosis cuprum elite gravida adiscipling nulla gravida est.
				</p>
				<h4 class="page_margin_top">Heading H4</h4>
				<p class="text">
					Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.
					Metro pulvinare est dosis cuprum elite gravida adiscipling nulla gravida est.
				</p>
				<h5 class="page_margin_top">Heading H5</h5>
				<p class="text">
					Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.
					Metro pulvinare est dosis cuprum elite gravida adiscipling nulla gravida est.
				</p>
				<h6 class="page_margin_top">Heading H6</h6>
				<p class="text">
					Maecenas mauris elementum, est morbi interdum cursus at elite imperdiet libero. Proin odios dapibus integer an nulla augue pharetra cursus.
					Metro pulvinare est dosis cuprum elite gravida adiscipling nulla gravida est.
				</p>		
				<h4 class="box_header page_margin_top">Nested Unordered List</h4>	
				<ul class="list no_border spacing">
					...
					<li class="bullet style_2 parent">
						...
						<ul class="list no_border">
							<li class="bullet style_2">Washington and Oregon Plan</li>
							<li class="bullet style_2">California Initiative</li>
						</ul>
					</li>
				...
				<h4 class="box_header page_margin_top">Nested Ordered List</h4>	
				<ul class="list no_border spacing">
					<li>1. New England Governors and Eastern Canadian Premiers Plan</li>
					<li>
						2. West Coast Governors Global Warming Initiative
						<ul class="list indent no_border">
							<li>a. Washington and Oregon Plan</li>
							<li>b. California Initiative</li>
						</ul>
					</li>
					<li>3. Midwest Greenhouse Gas Reduction Accord</li>
					<li>4. Southwest Climate Change Initiative</li>
					<li>5. Regional Greenhouse Gas Initiative</li>
				</ul>
				<h4 class="box_header page_margin_top">Dropcaps</h4>
				<div class="dropcap page_margin_top">
					<div class="dropcap_label">
						<h3>L</h3>
					</div>
					<p class="padding_top_0">orem ipsum dolor sit amet, consectetur adipiscing elit. Ut volutpat rutrum eros amet sollicitudin interdum. 
				...
				<div class="dropcap page_margin_top">
					<div class="dropcap_label active">
						<h3>L</h3>
					</div>
					<p class="padding_top_0">orem ipsum dolor sit amet, consectetur adipiscing elit. Ut volutpat rutrum eros amet sollicitudin interdum. 
					Suspendisse pulvinar, velit nec pharetra interdum, ante tellus ornare mi, et mollis tellus neque vitae elit. 
				...
				<h4 class="box_header page_margin_top">Paragraph Quotes</h4>
				<div class="row">
					<div class="post single">
						<div class="text">
							<blockquote class="inside_text margin_top_20">
							...
							<p>There is no evidence to counter the basic premise that a warmer world will lead to more intense daily and hourly rain events. When heavy rain in 2000 devastated parts of Britain, a later study found the climate change had doubled the chances of the flood occurring, said Julia Slingo. The Environment Agency, the body responsible for combating floods and managing rivers, has also been blamed for failing to curb the disasters. But there’s an ever larger debate over the role of climate change in the current floods and storms, and it has been unremittingly hostile.</p>
							<blockquote class="inside_text margin_top_20 simple right">
								Politicians have looked weak in the face of such natural disaster, with many facing criticism from local residents.
								<span class="author">&#8212;&nbsp;&nbsp;Julia Slingo, ETF</span>
							</blockquote>
				...
				<h4 class="box_header page_margin_top">Buttons</h4>
				<div class="row">
					<a class="more button_preview" href="#">SMALL BUTTON</a>
					<a class="more highlight button_preview" href="#">SMALL BUTTON</a>
					<a class="more active button_preview" href="#">SMALL BUTTON</a>
				</div>
				<div class="row">
					<a class="more medium button_preview" href="#">MEDIUM BUTTON</a>
					<a class="more highlight medium button_preview" href="#">MEDIUM BUTTON</a>
					<a class="more active medium button_preview" href="#">MEDIUM BUTTON</a>
				</div>
				<div class="row">
					<a class="more big button_preview" href="#">LARGE BUTTON</a>
					<a class="more highlight big button_preview" href="#">LARGE BUTTON</a>
					<a class="more active big button_preview" href="#">LARGE BUTTON</a>
				</div>
			</div>
